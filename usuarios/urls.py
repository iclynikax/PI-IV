...
urlpatterns = [
    ...
    path('cliente/<int:id_cliente>/', views.fnct_clnts_edit, name="url_clnts_edit"),

    path('buscar-endereco/<str:cep>/', views.buscar_endereco, name='buscar_endereco'),

    path('cliente_PI_I/<int:id_cliente>/', views.fnct_clnts_edit_PI_I, name="url_clnts_edit_PI_I"),
    ...
    path('enviar_email_restar_senha/', views.fnct_enviar_email_restar_senha, name="url_enviar_email_restar_senha"),
    path('upgrade_senha/<str:token>', views.fnct_upgrde_snha , name="url_fnct_upgrde_snha"),
