...
class Perfil(models.Model):
    ...
    UF = models.ForeignKey(UfEstados, on_delete=models.DO_NOTHING, null=True, blank=True)
...
class Prfl_Endereco(models.Model):
    ...
    Descricao = models.TextField(null=True, blank=True)
    status = models.CharField(max_length=1, choices=status_Prfl_Endereco, default='A')
